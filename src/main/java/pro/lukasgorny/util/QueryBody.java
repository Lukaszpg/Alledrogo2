...
public class QueryBody {
    ...
    public class AuctionQuery {
        ...
        public static final String FIND_ALL_NOT_ENDED_FOR_USER = "SELECT a FROM Auction a WHERE a.hasEnded = false AND a.seller.id = :userId";
    ...
    public class TransactionQuery {
        ...
        public static final String FIND_ALL_BOUGHT_ITEMS_WITHOUT_RATING_FOR_BUYER = "SELECT t FROM Transaction t INNER JOIN t.auction a WHERE t.user.id = :userId AND t.buyerRating is null AND ((t.transactionType = 'BUYOUT' AND t.offerAccepted = NULL) OR (t.transactionType = 'BID' AND a.hasEnded = true AND t.offerAccepted = true))";
        public static final String FIND_ALL_SOLD_ITEMS_WITHOUT_RATING_FOR_SELLER = "SELECT t FROM Transaction t INNER JOIN t.auction a WHERE a.seller.id = :userId AND t.sellerRating is null AND ((t.transactionType = 'BUYOUT' AND t.offerAccepted = NULL) OR (t.transactionType = 'BID' AND a.hasEnded = true AND t.offerAccepted = true))";
